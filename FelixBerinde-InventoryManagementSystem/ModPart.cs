...
namespace FelixBerinde_InventoryManagementSystem
{
    ...
    {
        private readonly ToolTip rangeValidationToolTip = new ToolTip { ShowAlways = true };
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            if (int.Parse(minBox.Text) > int.Parse(maxBox.Text))
            {
                ...
                rangeValidationToolTip.SetToolTip(minBox, "Minimum must be less than maximum.");
                rangeValidationToolTip.SetToolTip(maxBox, "Minimum must be less than maximum.");
            ...
            rangeValidationToolTip.SetToolTip(minBox, string.Empty);
            rangeValidationToolTip.SetToolTip(maxBox, string.Empty);
            ...
            if (int.Parse(inventoryBox.Text) > int.Parse(maxBox.Text) || int.Parse(inventoryBox.Text) < int.Parse(minBox.Text))
            {
                ...
                rangeValidationToolTip.SetToolTip(inventoryBox, "Inventory must be between minimum and maximum.");
                MessageBox.Show("Inventory must be between minimum and maximum.");
                return;
            }

            inventoryBox.BackColor = System.Drawing.Color.White;
            rangeValidationToolTip.SetToolTip(inventoryBox, string.Empty);
